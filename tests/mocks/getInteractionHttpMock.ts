...
type DiscordInteractionBody<T extends InteractionType,Data> = APIBaseInteraction<T, Data>;

type BasicInteractionPayloadOpts<T extends InteractionType, Data extends object> = {
  guild_id?: string;
  channel_id?: string;
  data?: Data;
  type?: T;
...
const getBasicInteractionPayload = <T extends InteractionType, D extends object>({
  data = {} as D,
...
export const getInteractionCommandHttpMock = <D extends object>(
  ...
  req: MockRequest<Request<any, any, DiscordInteractionBody<InteractionType.ApplicationCommand,D>, any, any>>;
} => ({
  res: createResponse(),
  req: createRequest({
    method: "POST",
...
export const getInteractionModalHttpMock = <D extends object>(
  ...
  res: MockResponse<Response>;
  req: MockRequest<Request<any, any, DiscordInteractionBody<InteractionType.ModalSubmit,D>, any, any>>;
} => ({
  res: createResponse(),
  req: createRequest({
    method: "POST",
