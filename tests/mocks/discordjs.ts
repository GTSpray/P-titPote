...
export class DiscrodRESTMock {
    ...
    public static register({ verb, fullRoute }: RESTMockRegisterOPtions, result: unknown) {
    ...
    private request(verb: DiscrodRESTMockVerb, fullRoute: RouteLike, options?: RequestData) {
        const key = DiscrodRESTMock.resultkey(verb, fullRoute);
