...
type ApiMessagesChannelDataOptions = { channel_id?: string, messages?: RESTGetAPIChannelMessagesResult, length?: number };
export const getApiMessagesChannelData = (options?: ApiMessagesChannelDataOptions): RESTGetAPIChannelMessagesResult => {
