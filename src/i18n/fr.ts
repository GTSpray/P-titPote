export const fr = {
  ...
  'common.notAllowed': 'Ahem... je ne suis pas habilité à le faire 🤷',
  ...
  'alias.sub.set.description': 'définit un alias message',
  'alias.sub.say.description': "demande a p'titpote d'envoyer le message",
  'alias.sub.rm.description': 'supprime un alias message',
  ...
  'alias.modal.set.title': 'Définir un alias',
  'alias.modal.say.title': 'Poster un alias',
